<template>
  <div class="flex flex-col w-full max-w-[450px] py-4 pb-3 px-5 bg-card rounded-sm">
    ...
    >
      <SelectTrigger class="w-full mt-4 bg-background! text-xs font-medium">
...
import { EQ_FREQUENCIES, EQ_PRESET_CATEGORIES, EQ_PRESETS, getPresetsByCategory } from "./constants";
