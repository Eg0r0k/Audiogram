...
export interface EQPreset {
  name: string;
  gains: number[];
  category: "basic" | "genre" | "effect" | "device";
}
...
export const EQ_PRESETS = {
  ...
  "Vocal Boost": {
    name: "Vocal Boost",
    gains: [-2, -2, -1, 0, 4, 5, 4, 2, 0, -1],
    category: "basic",
  },

  "Pop": {
    name: "Pop",
    gains: [-1, 1, 3, 4, 3, 1, -1, -1, 2, 2],
    category: "genre",
  },
  "Rock": {
    name: "Rock",
  ...
  "Acoustic": {
    name: "Acoustic",
    gains: [3, 2, 1, 0, 1, 1, 2, 2, 3, 2],
    category: "genre",
  },

  "Deep Bass": {
    name: "Deep Bass",
    gains: [8, 6, 3, 0, -2, -2, -1, 0, 0, 0],
    category: "effect",
  },
  "Bright": {
    name: "Bright",
    gains: [-2, -1, 0, 0, 1, 2, 3, 4, 5, 5],
    category: "effect",
  },

  "Crisp": {
    name: "Crisp",
    gains: [-1, 0, 0, 0, 0, 1, 2, 3, 4, 4],
    category: "effect",
  },
  "Live": {
    name: "Live",
    gains: [-2, 0, 2, 3, 3, 3, 2, 1, 2, 2],
    category: "effect",
  },

  "Headphones": {
    name: "Headphones",
    gains: [3, 4, 3, 1, -1, -1, 0, 2, 3, 4],
    category: "device",
  },
  "Small Speakers": {
    name: "Small Speakers",
    gains: [6, 5, 4, 2, 1, 0, 0, 1, 2, 2],
    category: "device",
  },
  "Laptop": {
    name: "Laptop",
    gains: [5, 4, 3, 1, 0, 0, 1, 2, 3, 3],
    category: "device",
  },
  "Car": {
    name: "Car",
    gains: [4, 3, 1, 0, -1, -1, 0, 2, 4, 5],
    category: "device",
  },
  "Earbuds": {
    name: "Earbuds",
...
export const getPresetsByCategory = (category: EQPresetCategory): EQPreset[] => {
  return Object.values(EQ_PRESETS).filter(preset => preset.category === category);
};
