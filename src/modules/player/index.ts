...
export { default as PlayBarControls } from "./components/PlayBarControls.vue";
export { default as PlayerBarNotification } from "./components/PlayerBarNotification.vue";
