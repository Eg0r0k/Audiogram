<template>
  ...
  >
    ...
    <!-- Type badge (only shown on hover on desktop) -->
    <span
      class="hidden sm:block text-xs text-muted-foreground font-medium shrink-0
             opacity-0 group-hover:opacity-100 transition-opacity capitalize"
    >
      {{ typeLabel }}
    </span>
  </div>
